...
<%@page import="cn.senlin.jiaoyi.entity.InformationCode"%>
...
<head>
  ...
  <title>森林：售卖</title>
  <meta name="description" content="这是一个 sell 页面">
  ...
  <script src="${pageContext.request.contextPath}/js/upload/jquery-2.2.1.js" type="text/javascript"></script>
  <script src="${pageContext.request.contextPath}/js/upload/UploadPic.js" type="text/javascript"></script>
  ...
  function OK() {
	  if(document.Sell.articleName.value.length < 1) {
		  ...
		  if(floor === 0) {
			  ...
			  Sell.action="${pageContext.request.contextPath}/sell/addArticle";
			  document.Sell.submit();
		  }
	  }
  }
  function Cancel() {
	  Sell.action="${pageContext.request.contextPath}/jsp/trading/article.jsp";
	  document.Sell.submit();
  }
  </script>
</head>
      ...
      <form action="" name="Sell" class="am-form am-form-horizontal" method="post" enctype="multipart/form-data" >
        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">     
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" name="articlePrice" id="articlePrice" placeholder="人民币"/>
              </div>
            </div>
            ...
            <div class="am-u-sm-9">
              ...
              <%
                for (Object o : inFloor) {
                  InformationCode infc = (InformationCode) o;
                  if (infc.getCodeName().equals(usin.getUserFloor())) {
              %>
                    <label class="am-btn am-btn-default am-btn-xs">
                      <input id="articleFloor" type="radio" name="articleFloor" value="<%=infc.getCodeName() %>"
                             checked> <%=infc.getCodeName() %>
                    </label>
              <%
                  } else {
              %>
                    <label class="am-btn am-btn-default am-btn-xs">
                      <input id="articleFloor" type="radio" name="articleFloor" value="<%=infc.getCodeName() %>"> <%=infc.getCodeName() %>
                    </label>
              <%
                  }
                }
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <textarea class="" rows="10" name="articleDescribe" id="articleDescribe" placeholder="" cols=""></textarea>
              </div>
            </div>

            <div class="am-form-group">
              <div class="am-u-sm-9 am-u-sm-push-3">
                <input type="button" onclick="OK()" value="发  布" class="am-btn am-btn-primary">
