...
function change_submit() {
	if (old_flag&&password_flag) {
		document.forms['modify_password'].elements['modify'].disabled = '';
	} else {
		document.forms['modify_password'].elements['modify'].disabled = 'disabled';
	}
}
/*
 * 公用程序
...
function ok() {
	document.forms['modify_password'].action = getRootPath() + "user/modifyPassword ";
	document.forms['modify_password'].submit();
}
function cancel(userLevel) {
	document.forms['modify_password'].action = getRootPath() + "jsp/user/" + userLevel + ".jsp";
	document.forms['modify_password'].submit();
}